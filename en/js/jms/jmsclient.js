(function($, window, document,undefined) {
   ...
   $clientURL = "http://118.178.94.7:9998/jms/";  //服务器
      // $clientURL = "http://115.28.24.76:9999/jms/";
   //$clientURL = "http://192.168.1.100:9999/jms/"

   //jiangsu hotel
	// $clientURL = "http://172.16.7.30:9999/jms/"
    ...
    $.JMSClient = function (path,opt,callback) {
     ...
     var options = $.extend({}, defaults, opt);
       ...
       $.ajax({
		    ...
		    beforeSend:function(XMLHttpRequest){$('#body-center').block({ 
																    message: '数据加载中。。。',
		                                                           css: { 
																	border: 'none', 
																	padding: '15px', 
         ...
         complete:function(XMLHttpRequest, textStatus){$('#body-center').unblock();
           },
